    ...
    return <section id="home" className="home w-full  h-[90vh]">
        <div className="home-content w-full h-[90vh] flex justify-center items-center">
            <div className="content flex flex-col justify-center items-center">
                <h2 className="text-slate-50 text-4xl font-bold text-center">Welcome to Travel DilSe</h2>
                ...
                <a href="#booking" class="px-4 py-2 my-4 bg-red-700 text-slate-100 rounded-md">Book Now</a>
            </div>
        </div>
    </section>
}
