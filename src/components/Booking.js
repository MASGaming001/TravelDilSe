    ...
    return <>
        <section className="py-10 px-5">
            <div className="block md:flex items-start justify-center">
                <img className="w-[100%] md:w-[50%] aspect-square p-5 md:p-10" src="https://images.pexels.com/photos/2104044/pexels-photo-2104044.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="booking-img" />
